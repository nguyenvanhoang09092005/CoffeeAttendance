...
class CustomUserAdmin(DefaultUserAdmin):
    ...
    fieldsets = (
        ...
        ('Roles', {'fields': ('is_employee', 'is_manager', 'is_admin')}),  # Role fields
    ...
    add_fieldsets = (
        (None, {
            'classes': ('wide',),
            'fields': ('username', 'email', 'password1', 'password2', 'is_authorized', 'is_employee', 'is_manager', 'is_admin')}
         ),
    )
    ...
    list_display = (
        ...
        'is_employee', 'is_manager', 'is_admin', 'is_staff', 'is_superuser'
    )

    # Filter users based on role and authorization
    list_filter = ('is_employee', 'is_manager', 'is_admin', 'is_authorized', 'is_staff', 'is_superuser')
