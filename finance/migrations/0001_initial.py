# Generated by Django 5.2.6 on 2025-10-09 04:36
    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        ...
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="standalone_expenses",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "revenue_date",
                    models.DateField(
                        default=django.utils.timezone.now, verbose_name="Ngày"
                    ),
                ),
                (
                    "shift",
                ...
                (
                    "vnpay",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=12, verbose_name="VNPay"
                    ),
                ),
                (
                    "no",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=12, verbose_name="Nợ"
                    ),
                ),
                (
                    "chi",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=12, verbose_name="Chi"
                    ),
                ),
                (
                    "tong",
                    models.DecimalField(
                        decimal_places=2, default=0, max_digits=12, verbose_name="Tổng"
                    ),
                ),
                (
                    "danh_thu_rong",
                ...
                (
                    ...
                    models.ImageField(
                        ...
                        verbose_name="Hình ảnh chứng từ",
                    ),
                ),
                (
                    "note",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "expense_date",
                    models.DateField(editable=False, verbose_name="Ngày chi"),
                ),
                (
                    "receipt_image",
                    models.ImageField(
